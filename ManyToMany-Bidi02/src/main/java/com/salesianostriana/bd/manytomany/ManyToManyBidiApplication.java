...
public class ManyToManyBidiApplication {
	...
	/*
	 * Este caso sería el de una asociación Muchos-A-Muchos bidireccional con métodos helper y FETCH EAGER
	 ...
	 * 
	 * CUIDADO CON REFERENCIAS CICLICAS, O CON TENER UN GRAN NÚMERO DE ASOCIACIONES
	 * "ENCADENADAS" CON FETCH DE TIPO EAGER
	 * 
	 */
