...
public class OneToMany03Application {

	public static void main(String[] args) {
		SpringApplication.run(OneToMany03Application.class, args);
	}
	
	/*
	 * En este ejemplo, la asociación será BIDIRECCIONAL, usando
	 * la anotación @ManyToOne y @OneToMany. SÍ USAREMOS
	 * la carga ansiosa (fetch de tipo EAGER)
	 * 
	 */
